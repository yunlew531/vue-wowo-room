    ...
    const data = reactive([
      {
        ...
        url: './assets/photo-1576354302919-96748cb8299e-1@2x.png' // /src/assets/images
      },
      {
        time: '',
        title: 'el 2021 SUMMER',
        url: './assets/photo-1599243075095-7199cae2c164-2@2x.png' // /src/assets/images
      },
      {
        time: '',
        title: 'SUMMER #1',
        url: './assets/photo-1565620731358-e8c038abc8d1-2@2x.png' // /src/assets/images
      }
    ]);
